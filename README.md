...
1. **Retrieval:** Relevant dataset descriptions are retrieved based on a user's query using semantic embeddings.
2. **Generation:** The retrieved datasets are used to generate contextually relevant responses that explain their relevance to the query.
